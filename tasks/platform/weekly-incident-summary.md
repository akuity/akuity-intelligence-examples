...
## Incident Statistics
- Retrieve incidents from the past 7 days
- Total incidents created in the past 7 days
- Breakdown by status: resolved, unresolved, auto-resolved
- Average time to resolution
- Incidents by severity/priority if available
...
- Identify namespaces with recurring issues
- Highlight clusters with elevated incident rates
